...
bus_for_school.bus_school_color('yellow')
bus_for_school.school_address('Ukraine, Kiev region, m.Slavutich, ave.  Druzhby Narodiv, 1')
bus_for_school.print_number_of_student()
bus_for_school.break_speed()
bus_for_school.seating_capacity(18)
bus_for_school.mileage_info()
